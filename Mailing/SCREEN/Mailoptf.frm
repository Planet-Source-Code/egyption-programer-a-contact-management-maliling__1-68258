...
On Error Resume Next
    ...
    UserName = frmMain.MapiSess.UserName
    MailPassWord = frmMain.MapiSess.Password
    NewSession = Abs(frmMain.MapiSess.NewSession)
    LogonUI = Abs(frmMain.MapiSess.LogonUI)
    DownLoadMail = Abs(frmMain.MapiSess.DownLoadMail)
...
On Error Resume Next
    ...
    frmMain.MapiSess.UserName = UserName
    frmMain.MapiSess.Password = MailPassWord
    frmMain.MapiSess.NewSession = NewSession
    frmMain.MapiSess.LogonUI = LogonUI
    frmMain.MapiSess.DownLoadMail = DownLoadMail
