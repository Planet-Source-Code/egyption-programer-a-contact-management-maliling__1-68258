...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    Else
        ...
        If frmMain.MapiMess.SessionID <> 0 Then
            Me.WindowState = 1
            Cancel = True
        End If
    End If
...
Private Sub Form_Resize()
    ...
    If WindowState <> 1 Then
        ...
        If frmMain.DispTools.Checked Then
...
' Previous and Next buttons as needed.
    ...
    End Select
'    frmMain.MapiMess.MsgIndex = MList.ListIndex
End Sub
...
Private Sub PrtImage_DragDrop(Source As Control, X As Single, y As Single)
    ' Same as File.PrintMessage on the frmMain File menu.
    Call PrintMail
End Sub
